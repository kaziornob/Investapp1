  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            singleRow(context, "Trading Volume", Colors.indigo[100], "\$"+"${metrics["trading_vol"]}"),
            singleRow(context, "Volume / Market Cap", Colors.indigo[50],
                "\$"+"${metrics["market_cap"]}"),
            singleRow(context, "24h Low / 24h High", Colors.indigo[100],
               metrics["24h_low_high"]),
            singleRow(context, "7d Low / 7d High", Colors.indigo[50],
                metrics["7d_low_high"]),
            singleRow(context, "Market Cap Rank", Colors.indigo[100],
                metrics["7d_low_high"]),
            singleRow(context, "All Time High", Colors.indigo[50],metrics["all_time_high"]),
            singleRow(context, "Gas Price (Median)", Colors.indigo[100],""),
