...
class SingleCryptoCurrencyDetails extends StatefulWidget {
  final coinDetails;

  SingleCryptoCurrencyDetails({this.coinDetails});

  @override
  _SingleCryptoCurrencyDetailsState createState() =>
      _SingleCryptoCurrencyDetailsState();
}

class _SingleCryptoCurrencyDetailsState
    extends State<SingleCryptoCurrencyDetails> {
  ...
  Widget build(BuildContext context) {
    Provider.of<CoinUrl>(context, listen: false)
        .getImageUrl(widget.coinDetails["coin_id"]);
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder(
          future: getData(widget.coinDetails),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ["bitcoin", "ethereum", "litecoin"]
                                    .contains(widget.coinDetails["coin_id"])
                                ? Column(
                                    children: [
                                      Stack(
                                        children: [
