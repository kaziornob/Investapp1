...
class InvestmentMasterclassPresenter {
  ...
  Future getClassAnswersComment(int answerId) async {
    ...
    String url =
        GlobalInstance.apiBaseUrl + 'forum/get_inv_class_answer_comment';
    print("post req url: $url");
    print("session token: $sessionToken");
    ...
    commentAnswerResponseModel =
        commentAnswerResponseModelFromJson(response.body);
  ...
  Future submitClassAnswersComment(int answerId, String answer) async {
    ...
    String url =
        GlobalInstance.apiBaseUrl + 'forum/create_inv_class_answer_comment';
    print("post req url: $url");
    print("session token: $sessionToken");
