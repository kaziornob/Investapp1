...
import 'package:auroim/widgets/animated_widgets/widget_scale_animation.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
                  ...
                  child: GestureDetector(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        typeOfLoginButton("Sign Up With Gmail", () {}),
                        SizedBox(
                          height: 5,
                        ),
                        typeOfLoginButton("Facebook", facebookButtonOnTapped),
                        SizedBox(
                          height: 5,
                        ),
                        typeOfLoginButton("Apple", () {}),
                      ],
                    ),
                  ),
                ),
  ...
  typeOfLoginButton(text, callback) {
