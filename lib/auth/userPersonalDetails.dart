...
class _UserPersonalDetailsState extends State<UserPersonalDetails> {
  ...
  checkUsername() async {
    if (usernameController.text.length > 3) {
      ...
      bool uniqueUsername = await Provider.of<UsernameFunctionalityProvider>(context, listen: false)
...
/*                                decoration: BoxDecoration(
                            ...
                            child: Form(
                              ...
                              child: Column(
                                children: <Widget>[
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            ...
                                            style:
                                            TextStyle(fontSize: 16, fontFamily: 'Roboto', color: Color(0xff666666)),
                                            ...
                                            decoration: new InputDecoration(
                                                ...
                                                hintStyle: TextStyle(
                                                    color: Colors.grey[600], fontSize: ConstanceData.SIZE_TITLE14),
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(bottom: 20, left: 14, right: 10, top: 10),
                                    child: Row(
  ...
  _submit() async {
    ...
    if (_detailFormKey.currentState.validate() == false ||
        (datePicker.year == null || datePicker.month == null || datePicker.day == null)) {
      setState(() {
        _isDetailInProgress = false;
