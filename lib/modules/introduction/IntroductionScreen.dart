...
class _IntroductionScreenState extends State<IntroductionScreen> with SingleTickerProviderStateMixin {
  ...
  List listPaths = [
    ...
    },
    {
      ...
      "firstPara": "Let globally licensed (SEC, SFC,  SEBI FPI) asset manager build a personalized portfolio for you based on your risk appetite and goals",
    ...
    },
    {
      ...
      "firstPara": "Master investment concepts with our Adaptive Learning Investment module. "
            ...
            Visibility(
              ...
              child: LayoutBuilder(
                builder: (context, constraints){
                  return Container(
                    width: currentIndex==1 ? constraints.maxWidth * 0.67 : constraints.maxWidth * 0.73,
                    child: Text(
                      "${allFields["firstPara"]}",
                      style: TextStyle(
                        fontSize: ConstanceData.SIZE_TITLE14,
...
/*            SizedBox(
            ...
            Container(
              height: currentIndex==0 ? MediaQuery.of(context).size.height * 0.38 : MediaQuery.of(context).size.height * 0.37,
              width: MediaQuery.of(context).size.width,
...
/*            SizedBox(
            ...
            LayoutBuilder(
                builder: (context, constraints){
                  return Container(
                    width: currentIndex==0 ? constraints.maxWidth * 0.75 : constraints.maxWidth * 0.75,
