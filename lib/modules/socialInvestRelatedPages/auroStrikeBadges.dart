  ...
  Widget _generateRightHandSideColumnRow(BuildContext context, int index) {
    return Row(
      children: <Widget>[
            ...
            children: <Widget>[
              GestureDetector(
                onTap: () {
                  var tempField = {
                    "rankingNum": "${index + 1}",
                    "name": "${user.clubInfo[index].name}",
                    "philosophy": "${user.clubInfo[index].philosophy}",
                    "trackRecord": "${user.clubInfo[index].trackRecord}",
                    "image": "${user.clubInfo[index].imageName}"
                  };
        ...
        Container(
          child: Text(
            user.clubInfo[index].trackRecord,
            style: new TextStyle(
              fontSize: ConstanceData.SIZE_TITLE15,
              fontFamily: "Roboto",
            ),
