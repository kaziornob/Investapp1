...
class _MainLearnMarketTabState extends State<MainLearnMarketTab> {
  ...
  onInitDisplayBootomSheet() async {
    int showPopupData =
        await _reusableFunctions.learnMarketplacePagePopupGetData();
...
//                         textColor:
//                             globals.isGoldBlack ? Colors.black : Colors.white,
//                         callback: () {
//                           Navigator.of(context).push(
//                             MaterialPageRoute(
...
//                       FutureBuilder(
//                         future:
//                             _featuredCompaniesProvider.getUserCoinsScoreData(),
...
//                                 ChartData(
//                                   element.x,
//                                   (snapshot.data[snapShotFields[index]].length -
//                                           1)
//                                       .toDouble(),
//                                   element.color,
//                                 ),
