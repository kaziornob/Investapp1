...
class _CreatePollState extends State<CreatePoll> {
      ...
      if (optionList != null && optionList.length != 0) {
        for (PollOption optObj in optionList) {
          if (optObj.id == itemId) {
            ...
            else if (from == "link") optObj.textLink = text;
          }
        }
      }
    } on FormatException {}
  ...
  Widget getDurationField() {
    return new FormField(
      ...
      validator: (val) {
        return ((val != null && val != '') ||
                (selectedPollDuration != null && selectedPollDuration != ''))
            ? null
            : 'choose one';
      },
    );
                    ...
                    child: !_isInProgress
                        ? Column(
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        'Which Tech stock offers the best upside return for the next 1 year? ',
                                    hintStyle: TextStyle(
                              ...
                              Container(
                                height:
                                    optionList.length != 0 ? optionHeight : 0.0,
