    ...
    tempQuestions = [
      {
        "screenBackGroundColor":
            parentFrom == 'Accredited Investor' ? 0xFF000000 : 0xFF87b5eb,
        "buttonBackGroundColor":
            parentFrom == 'Accredited Investor' ? 0xFFfec20f : 0xFF4682B4,
        ...
        "qusOptions": [
          {
            "title": "Cautious",
            "subTitle":
                "Low risk appetite, expected returns higher than saving accounts, ideal for individuals at a late stage in their carrer",
          ...
          },
          {
            "title": "Modest",
            "subTitle":
                "Medium risk appetite,looking for average returns, with slight ability to sustain losses",
            "option_value": "Modest",
            "num_value": "0.15"
          },
          {
            "title": "Aggressive",
            "subTitle":
                "High-risk appetite seeking significant returns with the ability to sustain losses, investing with long-term goals",
            "option_value": "Aggressive",
            "num_value": "0.25"
          },
          {
            "title": "Extremely Aggressive",
            "subTitle":
                "Extremely high-risk appetite, seeking great returns willing to take on the risk",
